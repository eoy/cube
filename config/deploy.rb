...
set :scm, "git"
set :repository, "git@bitbucket.org:agencyleroy/munchies.git" # "git@github.com:eoy/#{application}.git"
set :branch, "master"
...
namespace :deploy do
  ...
  namespace :uploads do
    ...
    task :symlink do
      run "cd #{release_path}/public; rm -rf uploads; ln -s #{shared_path}/uploads ."
      run "cd #{release_path}/public; rm -rf images; ln -s #{shared_path}/images ."
      run "cd #{release_path}/public; rm -rf system; ln -s #{shared_path}/system ."
    end
  end
